...
public class MarkdownCodeBlockElement extends CodeBlockElement<MarkdownStyle, MarkdownRenderer> {
    public MarkdownCodeBlockElement(@NotNull MarkdownStyle style, @NotNull LayoutStyle layoutStyle, @Nullable Element<MarkdownStyle, MarkdownRenderer> parent, @NotNull String qName, @Nullable Attributes attributes) {
